...
export const routes: Routes = [
  ...
  { path: 'veranstalter', title: 'Stock-Party', component: VeranstalterComponent, canActivate: [AuthGuard], data: { roles: ['veranstalter'] }},
  { path: 'user',
    title: 'Stock-Party',
    children: [
  ...
  { path: 'personal', title: 'Stock-Party', component: PersonalComponent, canActivate: [AuthGuard], data: { roles: ['personal'] }},
