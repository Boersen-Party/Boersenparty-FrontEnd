...
import {PriceOverview} from '../drink-price-overview-user/priceoverview';
import {CommonModule} from '@angular/common';

@Component({
  selector: 'app-meal-price-overview-user',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './meal-price-overview-user.component.html',
  styleUrl: './meal-price-overview-user.component.css'
})
export class MealPriceOverviewUserComponent {
